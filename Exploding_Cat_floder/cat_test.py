                ...
                while True:
                    ...
                    try:
                        ...
                        if ask_want_to_draw - 1 in turn_list:
                            while "Nope" in player_deck[ask_want_to_draw-1] and ask_want_to_draw - 1 != turn:
